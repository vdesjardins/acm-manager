...
type CertificateInterface interface {
	...
	Apply(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error)
	ApplyStatus(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error)
...
func (c *certificates) Apply(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error) {
	if certificate == nil {
...
func (c *certificates) ApplyStatus(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error) {
	if certificate == nil {
		return nil, fmt.Errorf("certificate provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
