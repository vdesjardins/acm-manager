...
func (c *FakeCertificates) Apply(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error) {
	if certificate == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(certificatesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Certificate{})
...
func (c *FakeCertificates) ApplyStatus(ctx context.Context, certificate *acmmanagerv1alpha1.CertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Certificate, err error) {
	if certificate == nil {
		return nil, fmt.Errorf("certificate provided to Apply must not be nil")
	}
	data, err := json.Marshal(certificate)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(certificatesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.Certificate{})
